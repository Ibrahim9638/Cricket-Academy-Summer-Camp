...
const About = () => {
  return (
    <div
      className="grid grid-cols-1 lg:grid-cols-2 p-8 py-8  gap-4 bg-[#dae7f1] m-0"
      data-aos="fade-down"
    ...
    >
      <div>
        ...
        <p className="font-lg">
          Developing proper batting technique involves mastering footwork, body
          positioning, grip, and shot selection. Coaches focus on refining these
          skills,Discipline,Fitness through drills, practice matches, and
